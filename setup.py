...
setup(
    name="dsss_hmwrk_2",  # Replace with your project's name
    version="0.1.0",  # Replace with the appropriate version
    author="Ajith",  # Replace with the author's name
    author_email="ajithgeorge0303@gmail.com",  # Replace with the author's email
    ...
    url="https://github.com/George-Dsss/dsss_hmwrk_2",  # Replace with the URL of your project (e.g., GitHub)
